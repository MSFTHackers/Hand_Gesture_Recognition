...
$(() => {
    ...
    function ViewModel() {
        ...
        self.clear = function() {
            while (self.predictions().length != 0)
    ...
    // 'https://chromeextensionsunil.blob.core.windows.net/extension/model.json';
    ...
    const mobilenetDemo = async() => {
        ...
        // mobilenet = await tf.loadLayersModel("https://chromeextensionsunil.blob.core.windows.net/extension/model.json");
    ...
    async function predict(imgElement) {
        ...
        const logits = tf.tidy(() => {
            ...
            return mobilenet.predict(transform(imgElement));
        });
    ...
    function showResults(imgElement, classes) {
        ...
        for (let i = 0; i < classes.length; i++)
            vm.addItem({ className: classes[i].className, probability: classes[i].probability.toFixed(3) });
        // console.log(vm.predictions);
    }
